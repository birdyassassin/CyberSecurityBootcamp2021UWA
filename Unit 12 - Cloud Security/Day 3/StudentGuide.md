...
- [Activity File: Ansible Playbooks](Activities/03_Ansible_Playbooks/README.md)
- [Ansible Playbook Example](Activities/03_Ansible_Playbooks/playbook_example.yml)
...
- [Activity File: Load Balancing](Activities/06_Load_Balancing/README.md)
...
- [Activity File: Security Configuration](Activities/09_Security_Configuration/README.md)
