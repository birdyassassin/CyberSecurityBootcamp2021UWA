...
- [Activity File: Creating a Report with `wmic` Output](Activities/08_WMIC_OS/readme.md)
...
- [Activity File: Creating Users and Setting Password Policies](Activities/14_Create_User_Password_Policy/readme.md)
...
- [Solution Guide: Task Scheduling](Activities/16_Scheduling_Tasks/readme.md)
