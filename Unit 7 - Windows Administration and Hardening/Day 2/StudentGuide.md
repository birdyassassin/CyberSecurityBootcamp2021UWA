...
- [Activity File: Move and Create Directories](Activities/03_Move_and_Create_Dir/Readme.md)
...
- [Activity File: Generating Windows Logs](Activities/06_Generating_Windows_Logs/Readme.md)
...
- [Activity File: Removing Unnnecessary Packages with Powershell Scripts](Activities/09_Removing_Packages/Readme.md)
